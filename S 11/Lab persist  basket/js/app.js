  ...
  section += YOURLAB.map((item) => {
    ...
    return `
                  <div class="product basket p-2">
                      ...
                      <option value="${publishersTitle[0]}">${publishersTitle[0]}  </option>
                       <option value="${publishersTitle[1]} ">${publishersTitle[1]}  </option>
                       <option value="${publishersTitle[2]}">${publishersTitle[2]} </option>
                       </select>
                   </div>
